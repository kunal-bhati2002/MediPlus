    ...
    return (
        <footer className="bg-gray-900 text-gray-300 py-12 w-full">
            <section className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 px-6 sm:px-10">
                ...
                {/* About Us */}
                <div>
                    <h2 className="text-xl font-semibold text-white mb-4">About Mediplus Hospital</h2>
                    <p className="text-sm leading-relaxed mb-5">
                        Mediplus Hospital is a leading healthcare institution committed to delivering
                        advanced medical care with compassion. Our dedicated team of specialists provides
                        world-class treatment, patient-centered services, and a safe healing environment.
                    </p>
                    <ul className="flex flex-wrap gap-4 text-lg">
                        <li className="hover:text-blue-500 transition"><FaFacebook /></li>
                        <li className="hover:text-sky-400 transition"><FaSquareTwitter /></li>
                ...
                <div>
                    ...
                    <div className="grid grid-cols-2 gap-x-4">
                        <ul className="space-y-2">
                            <li><NavLink to="/" className="hover:text-blue-500 transition">Home</NavLink></li>
                            <li><NavLink to="/about" className="hover:text-blue-500 transition">About Hospital</NavLink></li>
                            <li><NavLink to="/services" className="hover:text-blue-500 transition">Medical Services</NavLink></li>
                            <li><NavLink to="/departments" className="hover:text-blue-500 transition">Departments</NavLink></li>
                            <li><NavLink to="/contact" className="hover:text-blue-500 transition">Contact</NavLink></li>
                        </ul>
                        <ul className="space-y-2">
                            <li><NavLink to="/appointments" className="hover:text-blue-500 transition">Book Appointment</NavLink></li>
                            <li><NavLink to="/doctors" className="hover:text-blue-500 transition">Our Doctors</NavLink></li>
                            <li><NavLink to="/testimonials" className="hover:text-blue-500 transition">Patient Stories</NavLink></li>
                            <li><NavLink to="/faqs" className="hover:text-blue-500 transition">FAQs</NavLink></li>
                            <li><NavLink to="/blog" className="hover:text-blue-500 transition">Health Articles</NavLink></li>
                        </ul>
                    </div>
                </div>
                ...
                <div>
                    <h2 className="text-xl font-semibold text-white mb-4">Newsletter</h2>
                    <p className="text-sm mb-4">
                        Subscribe to receive health updates, wellness tips, and important announcements from Mediplus Hospital.
                    </p>
                    <form className="flex flex-col sm:flex-row gap-3">
                        <input
                            type="email"
