    ...
    return (
        <section className="container mx-auto sm:px-6 md:px-20 grid md:grid-cols-3 gap-6 px-4">
            <InfoCard
                ...
                description="Our emergency department operates round the clock with rapid response teams ready for critical and urgent medical situations. Call us anytime for immediate assistance."
                linkText="LEARN MORE"
                className="relative bottom-28 transform hover:-translate-y-2.5 transition-transform duration-200 hover:shadow-2xl hover:shadow-primary"
            />
            ...
            <InfoCard
                label="Schedule"
                title="Doctors' Timetable"
                description="View our specialists’ weekly availability and plan your visit conveniently. Appointments are open Monday to Saturday from 9:00 AM to 8:00 PM."
                linkText="VIEW SCHEDULE"
                className="relative bottom-28 transform hover:-translate-y-2.5 transition-transform duration-200 hover:shadow-2xl hover:shadow-primary"
            />
            ...
            <InfoCard
                ...
                description="Mediplus Hospital remains open daily for patient care. OPD Hours: Mon–Sat 8:00 AM – 8:00 PM, Sunday 9:00 AM – 4:00 PM."
                linkText="CONTACT US"
                className="relative bottom-28 transform hover:-translate-y-2.5 transition-transform duration-200 hover:shadow-2xl hover:shadow-primary"
            />
        </section>
