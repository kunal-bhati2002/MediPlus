...
function HelpingFamily() {
    return (
        <section className="">
            <div className="container mx-auto px-4 sm:px-6 md:px-20 py-28 text-center">
                <h2 className="text-3xl font-bold text-gray-800 mb-4">
                    Dedicated to Caring for You and Your Family
                </h2>
                <span className="text-blue-500 text-4xl inline-block mb-4">
                    <TbActivityHeartbeat />
                </span>
                <p className="text-gray-600 max-w-2xl mx-auto mb-12">
                    At Mediplus Hospital, our highly trained healthcare professionals provide
                    compassionate, continuous, and reliable medical support to ensure your family's
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-8">
                    <IconInfo
                        ...
                        paraInfo="Our emergency care unit is available 24/7, offering rapid medical assistance during critical moments when immediate care matters most."
                    />
                    ...
                    <IconInfo
                        icon={<GiCaduceus />}
                        heading="Advanced Pharmacy"
                        paraInfo="We provide safe, certified medications along with expert pharmaceutical guidance to support accurate and effective treatment."
                    />
                    ...
                    <IconInfo
                        ...
                        paraInfo="Our skilled specialists deliver advanced diagnostic and treatment services using modern medical technologies and evidence-based practices."
                    />
                </div>
            </div>
        </section>
