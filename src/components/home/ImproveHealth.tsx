...
function ImproveHealth() {
    ...
    return (<>
        <section className="container mx-auto px-4 sm:px-6 md:px-20 py-28 ">
            <div className="text-center">
                <h3 className="text-3xl font-bold text-gray-800 mb-4">
                    Comprehensive Services to Enhance Your Health
                </h3>
                <span className="text-blue-500 text-4xl inline-block mb-4">
                    <TbActivityHeartbeat />
                </span>
                <p className="text-gray-600 max-w-2xl mx-auto mb-12">
                    At Mediplus Hospital, we provide a wide range of healthcare services designed to keep you and your family healthy, happy, and well-informed.
                </p>
            </div>
            ...
            <div className="grid gap-10 md:grid-cols-2 mt-3 ">
                <div>
                    ...
                    <p className="my-5 text-gray-500">
                        Mediplus Hospital is a leading healthcare provider with experienced specialists, advanced facilities, and compassionate care for patients of all ages.
                    </p>
                    <p className="my-3 text-gray-500">
                        Our mission is to deliver safe, effective, and personalized medical treatments while ensuring your comfort and well-being.
                    </p>
                    <span className="flex items-center gap-2 font-semibold text-white ">
                        <a href="" className="transition-colors duration-200">
                            Learn More
                    ...
                    <ul className="grid grid-cols-2 text-gray-500 gap-4">
                        <ListItems content="General Checkups" />
                        <ListItems content="Pediatric Care" />
                        <ListItems content="Emergency Services" />
                        <ListItems content="Surgical Procedures" />
                        <ListItems content="Laboratory Tests" />
                        <ListItems content="Health Consultations" />
                    </ul>
                </div>
                <div>
                    <YouTubePlayer />
    ...
    return (
        <div className="relative w-full max-w-3xl mx-auto aspect-video rounded-2xl overflow-hidden shadow-lg">
            {!isPlaying ? (
                ...
                <iframe
                    className="w-full h-full"
                    src="https://www.youtube.com/embed/g-jj4KrmYPI?autoplay=1"
                    title="YouTube video player"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowFullScreen
                />
