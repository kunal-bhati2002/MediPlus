...
const testimonials: TestimonialDetails[] = [
    {
        image: "/images/Doctor_holding_patitent_hand.avif",
        name: "Mr. Anil Kumar",
        comment: "Mediplus Hospital provided excellent care during my treatment.",
    },
    {
        image: "/images/home_banner_image_1.jpg",
        name: "Mrs. Sharma",
        comment: "I highly recommend Mediplus. The doctors explained everything clearly and ensured I was comfortable.",
    },
    {
        image: "/images/video-bg.jpg",
        name: "Dr. Verma",
        comment: "State-of-the-art facilities combined with professional and friendly staff made my experience reassuring.",
    },
    {
        image: "/images/MRI_scan_photo.webp",
        name: "Rahul Singh",
        comment: "Quick diagnosis, effective treatment, and a caring team. Mediplus truly prioritizes patient well-being.",
    },
];
...
const TestimonialContent = ({ image, comment, name }: TestimonialDetails) => {
    return (
        <div className="px-5 py-8 mx-10 bg-white relative overflow-visible">
            <p className="text-gray-600 my-3">{comment}</p>
            <p className="font-semibold text-xl my-3">{name}</p>
            <img
                src={image}
