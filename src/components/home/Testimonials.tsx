            ...
            <div className="container mx-auto py-20 z-10">
                ...
                <div className="px-8 text-center mb-9">
                    <h3 className="text-white text-3xl font-bold mb-4">
                        Hear What Our Patients Say About Their Care at Mediplus
                    </h3>
                    <span className="text-white text-4xl inline-block mb-4">
                        <TbActivityHeartbeat />
                    </span>
                    <p className="text-white/90 max-w-xl mx-auto">
                        Our patients trust Mediplus Hospital for compassionate care, advanced treatments, and a comfortable healthcare experience.
                    </p>
                </div>
                <TestimonialCarousel />
            </div>
